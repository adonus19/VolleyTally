...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonList, IonInput, IonButton, IonLabel, IonItem, IonButtons } from '@ionic/angular/standalone';
...
@Component({
  standalone: true,
  selector: 'app-roster',
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonList, IonLabel, IonInput, IonButton, FormsModule, IonItem, IonButtons, ReactiveFormsModule],
