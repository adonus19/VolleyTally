...
export class DataService {
    ...
    async init(): Promise<void> {
        this.players.set(await this.storage.get<Player[]>('players', []));
        this.sessions.set(await this.storage.get<Session[]>('sessions', []));
        this.settings.set(await this.storage.get<Settings>('settings', this.settings()));
    }
